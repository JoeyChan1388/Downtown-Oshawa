    ...
    scene_seven: {
      ...
      hotSpots: [
        ...
        },
        {
          ...
          type: "scene",
          text: "Scene Twelve",
          sceneId: "scene_twelve",
					cssClass: 'hotspot_size oshawa-icon',
					createTooltipFunc: hotspot,
					createTooltipArgs: 'Scene Twelve',
					clickHandlerFunc: saveScene,
        },
      ],
    },
